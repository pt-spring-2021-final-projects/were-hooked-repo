...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Water alumCreek = new Water("Alum Creek","Alum Creek Lake is a man-made reservoir located in Delaware County, Ohio, United States.",5.00,25.00,"40.185718", "-82.966636", "/images/alumcreek.jpg","Impound",true,oldDutchmanBaitAndTackle,blueGill,largeMouthBass,smallMouthBass,perch,pike,muskie,saugeye);
